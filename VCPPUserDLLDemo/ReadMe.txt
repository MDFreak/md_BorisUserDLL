========================================================================
    DYNAMIC LINK LIBRARY: VCPPUserDLLDemo-Projektübersicht 
========================================================================

Diese VCPPUserDLLDemo-DLL wurde vom Anwendungs-Assistenten für
Sie erstellt.  

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien,
aus denen Ihre VCPPUserDLLDemo–Anwendung besteht.


VCPPUserDLLDemo.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen "VCPPUserDLLDemo.pch" und eine 
