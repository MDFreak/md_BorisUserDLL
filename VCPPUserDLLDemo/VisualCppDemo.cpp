...
typedef struct UserData{
	// TO DO:
	//
	// Fügen Sie hier die Parameterdefinitionen des User-DLL-Blocks ein
	//
	// Beispiel:
	//
	// a,b: extended;
...
void __stdcall InitUserDLL(PParameterStruct D)
{
	...
	// TO DO:
	//
	// Legen Sie hier z. B. Voreinstellungen für die Blockparameter fest
	// oder erzeugen Sie zusätzliche dynamische Variablen
	//
	// Beispiel:
	//
...
void __stdcall DisposeUserDLL(PParameterStruct D)
{
	...
	// TO DO:
	//
	// Geben Sie hier z. B. die in InitUserDLL zusätzlich erzeugten
...
void __stdcall GetNumberOfInputsOutputs(PNumberOfInputsOutputs D)
{
	// TO DO:
	//
	// Legen Sie hier die Anzahl der Blockein- und -ausgänge fest
	//
	// Beispiel:
	//
	D->Inputs=3;
	...
	// TO DO:
	//
	// Legen Sie hier die Bezeichnungen für die Ein- und Ausgänge des Blocks fest
	//
	// Beispiel:
...
void __stdcall SimulateDLL(WFNum T, PParameterStruct D, TInputArray Inputs, TOutputArray Outputs)
{
	// TO DO:
	// 
	// Stimmen Sie die Größe der Arrays auf die Anzahl der Ein-/Ausgänge des Blockes ab
	...
	// TO DO: Entfernen Sie die Kommentarzeichen, sofern Sie Blockausgänge verwenden:
	for(i=0; i<2; ++i)
